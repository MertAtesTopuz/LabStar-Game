...
{
    public string DeviceName = "LabStar";
    public string ServiceUUID = "44D10C00-3543-4A30-8E94-ACA5853D55C1";
    public string LedUUID = "44D10C20-3543-4A30-8E94-ACA5853D55C1";
    public string ButtonUUID = "44D10C21-3543-4A30-8E94-ACA5853D55C1";
    public Hook hook;


    [SerializeField] Text denemeTxt;
                ...
                switch (_state)
                {
                    ...
                    case States.Subscribe:
                        ...
                        BluetoothLEHardwareInterface.SubscribeCharacteristicWithDeviceAddress(_deviceAddress, ServiceUUID, ButtonUUID, (notifyAddress, notifyCharacteristic) =>
                        {
                            ...
                            //ButtonPositionText.text = "KAAAN2";
                        ...
                        }, (address, characteristicUUID, bytes) =>
                        {
                            ...
                            ButtonPositionText.text = "KAAAN4";
                        });
                        break;
